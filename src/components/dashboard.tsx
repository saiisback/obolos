  ...
  return <div className="app-shell">
    ...
    <div className="app-main" inert={mobileNav ? true : undefined}>
      <header className="global-header">
        <a className="brand" href="/" aria-label="Obolos home"><span className="brand-mark" aria-hidden="true"><span /><span /><span /></span><span>Obolos</span></a>
      ...
      {!state ? <div className="loading-state"><Loader2 className="spin" size={24} /><p>Opening your workspace…</p>{error && <button className="button" onClick={() => void refresh()}>Try again</button>}</div> : <div className={`workspace-body ${showInspector ? 'has-inspector' : ''}`}>
        <main className="content-area">
          ...
          <footer className="content-footer"><span className="footer-brand"><span className="tiny-brand">▰</span>Obolos</span><span>Work, within limits.</span><span>Hedera + Arc testnets</span></footer>
        </main>
