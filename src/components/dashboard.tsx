...
export default function Dashboard() {
  ...
  return <div className="app-shell">
    ...
    <aside ref={navigationRef} className={`mobile-navigation ${mobileNav ? 'navigation-open' : ''}`} role={mobileNav ? 'dialog' : undefined} aria-modal={mobileNav ? true : undefined} aria-label="Workspace navigation">
      <div className="mobile-navigation-heading"><strong>AgentGDP</strong><button className="icon-button" aria-label="Close navigation" onClick={() => setMobileNav(false)}><X size={22} /></button></div>
    ...
    <div className="app-main" inert={mobileNav ? true : undefined}>
      <header className="global-header">
        <a className="brand" href="/" aria-label="AgentGDP home"><span className="brand-mark" aria-hidden="true"><span /><span /><span /></span><span>AgentGDP</span></a>
