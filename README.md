...
Follow the boxes and arrows from discovery to execution, settlement and measurement. All eleven workflows are shown below with their actors, approval gates and recovery paths. Open any diagram to read it at full size.
...
### Account setup, private runner and spending authority
...
### Seller publishing, public discovery and service retirement
...
### Arc settlement, seller delivery and buyer acknowledgment
...
### Uncertain payments, delivery recovery, disputes and refunds
...
### Hedera A2A negotiation and HBAR or HTS x402 payments
...
### HCS-14 identity, payment audit and public evidence
...
### Finite Hedera Scheduled Transactions and delivery recovery
...
### Activity, GAP, surplus, productivity, inflation and velocity
...
### Optional repository research runner
