...
This is the intended full-flow recording plan; the actual evidence video must distinguish the earlier completed run from the escalation run whose Arc payment remains uncertain. Never edit the latter to appear fully completed. The [first paid run](evidence/2026-09-08-first-paid-run.md) already has real testnet receipts; record the separate price-increase flow and its actual approval. This build uses Speculos: show the emulator and disclose development mode rather than claiming physical Ledger footage. Keep any rehearsal recording explicitly labeled. Aim for 3:50 with human narration at 720p or higher; the intended event upload is 2–4 minutes.
